# Curriculum-to-Project Mapping

## Purpose

This document tracks practical evidence that the Demand Forecasting for Retail project covers the internship course material.

A topic is not considered implemented merely because it appears in documentation.

Actual evidence must exist.
